...
<footer className="bg-green-200/30 w-full mx-auto">
    <div className="mx-auto w-full max-w-[1280px] p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 font-medium">
                      <li className="mb-4">
                          <a href="/" className="hover:underline">Netiqa</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">© 2025 <a href="/" className="hover:underline">Netiqa™</a>. All Rights Reserved.
          </span>
