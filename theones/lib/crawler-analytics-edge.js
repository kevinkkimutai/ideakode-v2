// Edge Runtime compatible version - in-memory only
// For use in middleware only

class CrawlerAnalyticsEdge {
  constructor() {
    this.visits = [];
    this.maxVisits = 1000; // Smaller limit for edge runtime
  }
...
// Singleton instance
const crawlerAnalyticsEdge = new CrawlerAnalyticsEdge();

export default crawlerAnalyticsEdge;
