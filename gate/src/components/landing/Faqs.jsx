...
<div className='w-full grid grid-cols-1 md:grid-cols-2 gap-6  md:gap-12'>
    ...
    <p className='text-[16px] md:w-[60%] mt-3 dark:text-white'>
    ...
    {faqs.map((faq, index) => (
            <div key={index} className="accordion border-b  border-[#CED4DA]" role="accordion">
              ...
              >
                <span className="mr-4 text-[16px] lg:text-[20px] text-black dark:text-white font-[600] max-md:w-[70%]"> {t(`${faq.quiz}`)}</span>
                <div className="ml-auto   h-[28px] w-[28px] flex items-center justify-center">
                  {openFaqs.includes(index) ? (
                  <svg className="w-5 h-5 text-gray-800 rotate-180 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  ...
  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 9-7 7-7-7"/>
              ...
              >
               <p
  className="text-[14px] lg:text-[16px] font-[400] dark:text-gray-200 text-[#454546] md:w-[85%]"
